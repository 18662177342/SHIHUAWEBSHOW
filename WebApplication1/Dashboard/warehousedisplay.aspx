<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="warehousedisplay.aspx.cs" Inherits="WebApplication1.Oracledata" %>
...
<body>
    <header>
        ...
        <h1 style="float: right; margin: 8px">Realtime Delivery List Dashboard<br/><span style="font-size:16px;font-weight:bold;float:right"><span class="howmany"></span></span></h1>
            
    </header>
    <form id="form1" runat="server">
        <asp:GridView ID="GridView1" runat="server" Font-Size="16px" Font-Bold="True" Font-Family="Microsoft Yahei" Width="100%" CellPadding="4" GridLines="None" ForeColor="#333333">
...
<script>
    ...
    $(function () {
        ...
        $("#GridView1").find("tr").each(function (i) {
            ...
            $(this).find("td:last").each(function (i) {
...
<script>
    ...
    $(function () {
        ...
        document.cookie = SetCookie('currentPage', currentPage); //cookie位置
        document.cookie = SetCookie('sumPages', sumPages); //cookie位置
        $('.howmany').html('&nbsp&nbspPage:' + index_page + '/' + sumPages);//页数显示
        var $pager = $('<div class="page "  style="float:right"  ></div>');  //新建div，放入a标签,显示底部分页码  
        ...
        //$pagess[0].style.backgroundColor = "white";
        //$pagess[0].style.color = "black";
      
        setInterval(trig, 20000);
    });
...
<script>
    function trig() {
        ...
        var currentid = unescape(getCookie('currentPage'));
        var maxid = unescape(getCookie('sumPages'));
        ...
        if (parsecurrentid < parsemaxid) {
            ...
            document.cookie = SetCookie('currentPage', parsecurrentids);
