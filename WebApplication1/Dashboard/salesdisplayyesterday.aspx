<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="salesdisplayyesterday.aspx.cs" Inherits="WebApplication1.Dashboard.salesdisplay" %>
...
<body>
    <header>
        ...
        <h1 style="float: right; margin: 8px">Shop Order Tracking-<span style="color:red">Yesterday</span><br/><span style="font-size:16px;font-weight:bold;float:right"><span class="howmany"></span></span></h1>
    </header>
...
<script>
    ...
    $(function () {
        ...
        $("#GridView1").find("tr").each(function (i) {
            var thisrow = $(this);
            $(this).find("td:eq(7)").each(function (i) {
                if ($(this).html() == 0) {
...
<script>
    ...
    $(function () {
        ...
        document.cookie = SetCookie('currentPageYesterDay', currentPage);//cookie位置
        document.cookie = SetCookie('sumPagesYesterDay', sumPages);//cookie位置
...
<script>
    function trig() {
        var currentid = unescape(getCookie('currentPageYesterDay'));
        var maxid = unescape(getCookie('sumPagesYesterDay'));
        ...
        if (parsecurrentid < parsemaxid) {
            ...
            document.cookie = SetCookie('currentPageYesterDay', parsecurrentids);
